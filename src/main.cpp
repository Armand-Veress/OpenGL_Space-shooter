...
glm::vec3 earthPos = glm::vec3(3000.0f, 0.0f, 0.0f);
float earthScale = 100.0f; 
float earthOrbitRadius = 3000.0f; 
float earthOrbitSpeed = 0.2f;

glm::vec3 moonPos = glm::vec3(3250.0f, 0.0f, 0.0f);
...
//* Camera Keyboard Control + Forward Movement
